...
**Main Document (ebook) with the first 247 pages (without last chapter, 27-12-2022)**   [book_pytorch_scikit_learn_numpy.pdf](./text/book_pytorch_scikit_learn_numpy.pdf) <br />
...
**Abstract  (ISBN-13 : 979-8371441577)**  <br />
